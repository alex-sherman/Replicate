...
namespace ReplicateTest
{
    ...
    public class JSONRepGraphTypeless
    {
        ...
        public void TestDeserializeEmptyCollection()
        {
            ...
            Assert.IsTrue(output.MarshallMethod == MarshallMethod.Collection);
        ...
        public void TestDeserializeStringCollection()
        {
            ...
            Assert.AreEqual(MarshallMethod.Collection, output.MarshallMethod);
        ...
        public void TestDeserializeDictionary()
        {
            ...
            Assert.AreEqual(MarshallMethod.Object, output.MarshallMethod);
        ...
        public void DeserializeCardsResponse()
        {
            ...
            Assert.AreEqual("Get MD Working", output.AsObject["Cards"].AsObject["All"].AsCollection.First().AsObject["Title"].Value);
        }
    }
}
